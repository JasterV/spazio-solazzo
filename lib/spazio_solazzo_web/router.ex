defmodule SpazioSolazzoWeb.Router do
  ...
  scope "/", SpazioSolazzoWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {SpazioSolazzoWeb.LiveUserAuth, :live_user_required}
      #
      # If an authenticated user *may* be present:
      # on_mount {SpazioSolazzoWeb.LiveUserAuth, :live_user_optional}
      #
  ...
  scope "/", SpazioSolazzoWeb do
    ...
    confirm_route SpazioSolazzo.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [
        SpazioSolazzoWeb.AuthOverrides,
        Elixir.AshAuthentication.Phoenix.Overrides.DaisyUI
